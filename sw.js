...
const ASSETS_TO_CACHE = [
  ...
  '/assets/css/player.css?v=2.8.0',
  '/assets/js/app.js?v=2.8.0',
  '/assets/js/api.js?v=2.8.0',
  '/assets/js/feed.js?v=2.8.0',
  '/assets/js/i18n.js?v=2.8.0',
  '/assets/js/player.js?v=2.8.0',
  '/assets/js/ui.js?v=2.8.0',
  '/assets/js/ads.js?v=2.8.0',
  '/assets/js/analytics.js?v=2.8.0',
  '/assets/js/referral.js?v=2.8.0',
