const CACHE_NAME = 'missavj-cache-v2.8.74';
const API_CACHE_NAME = 'missavj-api-cache-v1';

const ASSETS_TO_CACHE = [
  '/assets/css/components.css?v=2.8.74',
  '/assets/css/base.css?v=2.8.74',
  '/assets/css/layout.css?v=2.8.74',
  '/assets/css/player.css?v=2.8.74',
  '/assets/js/app.js?v=2.8.74',
  '/assets/js/api.js?v=2.8.74',
  '/assets/js/feed.js?v=2.8.74',
  '/assets/js/i18n.js?v=2.8.74',
  '/assets/js/player.js?v=2.8.74',
  '/assets/js/ui.js?v=2.8.74',
  '/assets/js/ads.js?v=2.8.74',
  '/assets/js/analytics.js?v=2.8.74',
  '/assets/js/referral.js?v=2.8.74',
  '/assets/js/filter.js?v=2.8.74',
  '/assets/js/trending.js?v=2.8.74',
  '/assets/js/recent.js?v=2.8.74',
  '/assets/js/search.js?v=2.8.74',
  '/assets/js/actors.js?v=2.8.74',
  '/assets/js/studios.js?v=2.8.74',
  '/assets/js/categories.js?v=2.8.74',
