const CACHE_NAME = 'missavj-cache-v2.0.2';
const ASSETS_TO_CACHE = [
  '/',
  '/index.html',
  '/manifest.json',
  '/assets/css/components.css?v=2.0.2',
  '/assets/css/main.css?v=2.0.2',
  '/assets/css/base.css?v=2.0.2',
  '/assets/css/layout.css?v=2.0.2',
  '/assets/css/player.css?v=2.0.2',
  '/assets/js/app.js?v=2.0.2',
  '/assets/js/api.js?v=2.0.2',
  '/assets/js/feed.js?v=2.0.2',
  '/assets/js/i18n.js?v=2.0.2',
  '/assets/js/player.js?v=2.0.2',
  '/assets/js/ui.js?v=2.0.2',
  '/assets/js/ads.js?v=2.0.2',
  '/assets/js/analytics.js?v=2.0.2',
  '/assets/js/referral.js?v=2.0.2',
