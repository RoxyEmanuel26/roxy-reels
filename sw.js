const CACHE_NAME = 'missavj-cache-v2.2.4';
const ASSETS_TO_CACHE = [
  '/',
  '/index.html',
  '/manifest.json',
  '/assets/css/components.css?v=2.2.4',
  '/assets/css/main.css?v=2.2.4',
  '/assets/css/base.css?v=2.2.4',
  '/assets/css/layout.css?v=2.2.4',
  '/assets/css/player.css?v=2.2.4',
  '/assets/js/app.js?v=2.2.4',
  '/assets/js/api.js?v=2.2.4',
  '/assets/js/feed.js?v=2.2.4',
  '/assets/js/i18n.js?v=2.2.4',
  '/assets/js/player.js?v=2.2.4',
  '/assets/js/ui.js?v=2.2.4',
  '/assets/js/ads.js?v=2.2.4',
  '/assets/js/analytics.js?v=2.2.4',
  '/assets/js/referral.js?v=2.2.4',
