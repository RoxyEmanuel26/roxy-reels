const CACHE_NAME = 'missavj-cache-v2.5.3';
const ASSETS_TO_CACHE = [
  '/',
  '/index.html',
  '/manifest.json',
  '/assets/css/components.css?v=2.5.3',
  '/assets/css/main.css?v=2.5.3',
  '/assets/css/base.css?v=2.5.3',
  '/assets/css/layout.css?v=2.5.3',
  '/assets/css/player.css?v=2.5.3',
  '/assets/js/app.js?v=2.5.3',
  '/assets/js/api.js?v=2.5.3',
  '/assets/js/feed.js?v=2.5.3',
  '/assets/js/i18n.js?v=2.5.3',
  '/assets/js/player.js?v=2.5.3',
  '/assets/js/ui.js?v=2.5.3',
  '/assets/js/ads.js?v=2.5.3',
  '/assets/js/analytics.js?v=2.5.3',
  '/assets/js/referral.js?v=2.5.3',
