...
const routes = {
  '/':          () => import('./feed.js?v=1.0.2').then(m => m.init()),
  '/trending':  () => import('./trending.js?v=1.0.2').then(m => m.init()),
  '/recent':    () => import('./recent.js?v=1.0.2').then(m => m.init()),
  '/search':    () => import('./search.js?v=1.0.2').then(m => m.init(getParam('q'))),
  '/watch':     () => import('./player.js?v=1.0.2').then(m => m.init(getParam('id'))),
  '/category':  () => import('./feed.js?v=1.0.2').then(m => m.init({ category: getParam('name') })),
  '/actor':     () => import('./feed.js?v=1.0.2').then(m => m.init({ actor: getParam('name') })),
  '/studio':    () => import('./feed.js?v=1.0.2').then(m => m.init({ studio: getParam('name') })),
  '/tag':       () => import('./feed.js?v=1.0.2').then(m => m.init({ tag: getParam('name') })),
  
  // Taxonomy browsing routes for Actors, Studios & Categories
  '/actors':      () => import('./actors.js?v=1.0.2').then(m => m.init()),
  '/studios':     () => import('./studios.js?v=1.0.2').then(m => m.init()),
  '/categories':  () => import('./categories.js?v=1.0.2').then(m => m.init()),
...
function navigate(urlPath) {
  ...
  if (prevPath === '/watch' && routePath === '/watch' &&
    ...
    import('./player.js?v=1.0.2').then(m => {
