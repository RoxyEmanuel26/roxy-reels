...
module.exports = async (req, res) => {
  try {
    ...
    // - s-maxage=3600 (Player iframe disimpan di Edge CDN Vercel selama 1 jam)
    // - stale-while-revalidate=1800 (Servis data usang selama revalidasi background hingga 30 menit)
    // =========================================================================
